...
import DetectiveNode from '../sections/DetectiveNode';
import DetectiveChildItem from '../sections/DetectiveChildItem';
import DetectiveAnnotation from '../sections/DetectiveAnnotation';
import DetectiveStamp from '../sections/DetectiveStamp';
import '../sections/DetectiveWall.css';

export default function CrimeBoardBase({ boardRef, boardSize, hoveredNode, setHoveredNode, className = '' }) {
  ...
  return (
    <div className={`detective-board ${className}`} ref={boardRef}>
      {boardSize.w > 0 && (
