      ...
      <header className="bg-[#2c2a25] text-[#e8dcc8] py-8 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <nav className="flex items-center gap-3 mt-6">
            <Link
              to="/"
              className="cursor-pointer inline-flex items-center gap-2 px-3 py-1.5 border border-[#e8dcc8]/30 rounded-sm text-xs font-mono text-[#e8dcc8]/70 hover:bg-[#e8dcc8] hover:text-[#2c2a25] active:bg-[#e8dcc8]/70 active:text-[#2c2a25] transition-all duration-300 touch-manipulation"
            >
          ...
          <header className="mb-1 flex gap-6 items-start border border-[#3d3429]/10 rounded-sm px-4 py-3 bg-white">
            {post.thumbnail ? (
              ...
              <div className="flex-shrink-0 w-24 h-24 rounded overflow-hidden bg-[#e8dcc8] flex items-center justify-center">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#3d3429" strokeWidth="1.5" opacity="0.3">
            ...
            <div>
              ...
              <time className="text-sm font-mono text-[#3d3429]/60">
